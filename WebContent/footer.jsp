    <footer class="footer">
      ...
      Modern versions of assistive technologies will announce CSS generated content,
       ...
       used purely for decoration), we hide them with the aria-hidden="true" attribute.
       -->
        <p class="text-muted"><span class="glyphicon glyphicon-volume-up" aria-hidden="true">&nbsp;Bullhorn 2016</span></p>
      </div>
    </footer>